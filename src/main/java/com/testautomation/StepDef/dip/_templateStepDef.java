...
public class _templateStepDef extends ExtentReportListener {
	PropertiesFileReader obj;
	Properties properties;
	private WebDriver driver;
	ExtentTest logInfo = null;

	public _templateStepDef() throws IOException {
...
//		try {
//			logInatfo = test.createNode(new GherkinKeyword("Then"), "Giris_sayfasini_kontrol_et");
